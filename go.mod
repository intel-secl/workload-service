...
replace intel/isecl/lib/kms-client => gitlab.devtools.intel.com/sst/isecl/lib/kms-client.git v1.0/develop

replace intel/isecl/cms => gitlab.devtools.intel.com/sst/isecl/certificate-management-service.git v1.0/develop

replace intel/isecl/lib/clients => gitlab.devtools.intel.com/sst/isecl/lib/clients.git v1.0/develop

replace intel/isecl/lib/mtwilson-client => gitlab.devtools.intel.com/sst/isecl/lib/mtwilson-client.git v1.0/develop