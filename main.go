...
func printUsage() {
	...
	fmt.Fprintln(os.Stdout, "                                    Optional env variables specific to setup task are:")
	fmt.Fprintln(os.Stdout, "                                        - WLS_DB_SSLMODE=<db sslmode>                      : database SSL Connection Mode")
	fmt.Fprintln(os.Stdout, "                                        - WLS_DB_SSLCERT=<ssl certificate path>            : database SSL Certificate target path")
	fmt.Fprintln(os.Stdout, "                                        - WLS_DB_SSLCERTSRC=<ssl source certificate path>  : database SSL Certificate source path")
	fmt.Fprintln(os.Stdout, "")
