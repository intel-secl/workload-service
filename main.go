...
func printUsage() {
	...
	fmt.Println("    setup               Setup workload-service for use")
	fmt.Println("Available tasks for setup:")
	fmt.Println("    server              Setup http server on given port")
	fmt.Println("                        Environment variable WLS_PORT=<port> should be set")
	...
	fmt.Println("            			 - WLS_DB			: database schema name")
	...
	fmt.Println("            			 - HVS_PASSWORD	: HVS API password")
	...
	fmt.Println("            			 - KMS_PASSWORD	: KMS API password")	
	fmt.Println("    logs                Setup workload-service log level")
	fmt.Println("                        Environment variable WLS_LOG_LEVEL=<log level> should be set")
	fmt.Println("    aas                 Setup to create workload service user roles in AAS")
	fmt.Println("                        Environment variable AAS_API_URL=<aas URL> should be set")
 }
