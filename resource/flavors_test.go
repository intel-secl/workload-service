...
import (
	"bytes"
	"intel/isecl/workload-service/v4/repository/mock"
	"net/http"
	"net/http/httptest"
	"testing"
...
func TestDeleteNonExistentFlavorID(t *testing.T) {
	...
	req := httptest.NewRequest("DELETE", "/wls/v1/flavors/dddd021e-9669-4e53-9224-8880fb4e4080", nil)
...
func TestInvalidFlavorID(t *testing.T) {
	...
	r := setupMockServer(db)
	recorder := httptest.NewRecorder()
	req := httptest.NewRequest("DELETE", "/wls/v1/flavors/yaddablahblahblbahlbah", nil)
	req.Header.Add("Authorization", "Bearer "+BearerToken)
	r.ServeHTTP(recorder, req)
...
func TestFlavorPartValidation(t *testing.T) {
	...
	recorder := httptest.NewRecorder()
	req := httptest.NewRequest("POST", "/wls/v1/flavors", bytes.NewBufferString(badFlavorPartJson))
	...
	recorder = httptest.NewRecorder()
	req = httptest.NewRequest("POST", "/wls/v1/flavors", bytes.NewBufferString(imageFlavorPartJson))
	req.Header.Add("Content-Type", "application/json")
	req.Header.Add("Authorization", "Bearer "+BearerToken)
	r.ServeHTTP(recorder, req)
	...
	recorder = httptest.NewRecorder()
	req = httptest.NewRequest("POST", "/wls/v1/flavors", bytes.NewBufferString(containerImageFlavorPartJson))
	req.Header.Add("Content-Type", "application/json")
	req.Header.Add("Authorization", "Bearer "+BearerToken)
	r.ServeHTTP(recorder, req)
	assert.Equal(http.StatusCreated, recorder.Code)
	...
	recorder = httptest.NewRecorder()
	req = httptest.NewRequest("POST", "/wls/v1/flavors", bytes.NewBufferString(emptyImageFlavorPartJson))
	req.Header.Add("Content-Type", "application/json")
	req.Header.Add("Authorization", "Bearer "+BearerToken)
	r.ServeHTTP(recorder, req)
	assert.Equal(http.StatusBadRequest, recorder.Code)
	...
	recorder = httptest.NewRecorder()
	req = httptest.NewRequest("POST", "/wls/v1/flavors", bytes.NewBufferString(omittedImageFlavorPartJson))
	req.Header.Add("Content-Type", "application/json")
	req.Header.Add("Authorization", "Bearer "+BearerToken)
	r.ServeHTTP(recorder, req)
	assert.Equal(http.StatusBadRequest, recorder.Code)
...
func TestGetFlavorNoFilter(t *testing.T) {
	...
	recorder := httptest.NewRecorder()
	req := httptest.NewRequest("GET", "/wls/v1/flavors", nil)
	req.Header.Add("Content-Type", "application/json")
	req.Header.Add("Authorization", "Bearer "+BearerToken)
	r.ServeHTTP(recorder, req)
...
func TestGetFlavorsFilterByLabel(t *testing.T) {
	...
	recorder := httptest.NewRecorder()
	req := httptest.NewRequest("GET", "/wls/v1/flavors?label=label_image-test-3", nil)
	req.Header.Add("Content-Type", "application/json")
	req.Header.Add("Authorization", "Bearer "+BearerToken)
	r.ServeHTTP(recorder, req)
	// check we got a good response
...
func TestGetFlavorsFilterByUUID(t *testing.T) {
	...
	recorder := httptest.NewRecorder()
	req := httptest.NewRequest("GET", "/wls/v1/flavors?id=d6129610-4c8f-4ac4-8823-df4e925688c3", nil)
	req.Header.Add("Content-Type", "application/json")
	req.Header.Add("Authorization", "Bearer "+BearerToken)
	r.ServeHTTP(recorder, req)
	// check we got a good response
...
func TestGetFlavorsFilterWithTrue(t *testing.T) {
	...
	recorder := httptest.NewRecorder()
	req := httptest.NewRequest("GET", "/wls/v1/flavors?id=d6129610-4c8f-4ac4-8823-df4e925688c3&filter=true", nil)
	req.Header.Add("Content-Type", "application/json")
	req.Header.Add("Authorization", "Bearer "+BearerToken)
	r.ServeHTTP(recorder, req)
	// check we got a good response
...
func TestGetFlavorsNegFilterTrue(t *testing.T) {
	...
	recorder := httptest.NewRecorder()
	req := httptest.NewRequest("GET", "/wls/v1/flavors?filter=true", nil)
	req.Header.Add("Content-Type", "application/json")
	req.Header.Add("Authorization", "Bearer "+BearerToken)
	r.ServeHTTP(recorder, req)
	// check we got a good response
